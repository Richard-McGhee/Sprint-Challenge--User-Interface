...
Semantic HTML gives meaning to our HTML content. This helps to structure our HTML to make it easier to organize and utilize.
...
Version control. Allowing multiple people to work on the same thing simultaneously.

5. Define mobile-first design in your own words.

Creating your site to look good/work on mobile platforms first and then scaling it up.
